...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#080808] relative overflow-hidden">
      ...
      />
      {/* Glow blobs */}
      <div className="absolute top-[-20%] right-[10%] w-[500px] h-[500px] rounded-full bg-[#6B7A2A]/15 blur-[120px] pointer-events-none" />
      <div className="absolute bottom-[-20%] left-[5%] w-[500px] h-[500px] rounded-full bg-[#4A5420]/10 blur-[120px] pointer-events-none" />
        ...
        <div className="bg-[#111111] border border-white/8 rounded-2xl p-8 shadow-2xl shadow-black/60">
          ...
          <form action={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 bg-[#6B7A2A] hover:bg-[#7A8B30] text-white font-semibold rounded-xl transition-all disabled:opacity-50 flex items-center justify-center gap-2 text-[15px] mt-2 shadow-lg shadow-[#2A3010]/40"
            >
          ...
          <p className="text-center text-[13px] text-gray-600 mt-7">
            ...
            <Link href="/login" className="text-[#8B9A35] hover:text-[#6B7A2A] font-semibold transition">
              Sign in
            </Link>
          </p>
        </div>
