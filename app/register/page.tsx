...
function RegisterForm() {
  ...
  return (
    <>
      {loading && <LoaderOverlay message="Creating your account…" />}
      ...
      <div className="w-full max-w-md px-4">
        <div className="bg-[#141414] rounded-2xl shadow-2xl border border-[#262626] p-8">
          ...
          <div className="flex items-center gap-3 my-6">
            ...
            <span className="text-xs text-[#525252] uppercase">or</span>
            <div className="flex-1 h-px bg-[#262626]" />
          </div>
          ...
          <button
            ...
            className="w-full py-2.5 bg-[#1a1a1a] border border-[#262626] text-[#f5f5f5] font-medium rounded-xl hover:bg-[#222222] transition flex items-center justify-center gap-3"
          >
